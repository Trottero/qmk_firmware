...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  KC_SPC,  KC_SPC,           MO(1), MT(MOD_RGUI, KC_LEFT), XXXXXXX, MT(KC_RALT, KC_DOWN),   MT(MOD_RCTL, KC_RIGHT)
    ),
    ...
    [_FN_LAYER] = LAYOUT(
        ...
        _______, _______, _______, _______, QK_BACKLIGHT_DOWN,  QK_BACKLIGHT_TOGGLE, QK_BACKLIGHT_UP,  QK_BACKLIGHT_STEP, _______, _______, _______, _______, _______, _______,
